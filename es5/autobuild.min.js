...
System.register("/app/awy/core/manifest.js",[],function($__export){"use strict";var __moduleName="/app/awy/core/manifest.js";var config;return{setters:[],execute:function(){config={module_name:'awy_core',version:'0.0.0.1',description:"Base Awy classes and JS libraries",auto_use:[],before_bootstrap:{callback:"awy_core_model_app.onBeforeBootstrap"},routing:[['/initialize.js','awy_core_controller_main.initialize_js'],['/initialize.css','awy_core_controller_main.initialize_css']],views:{head:{view_class:'awy_core_view_head'},head_script:{view_class:'awy_core_view_text'},head_css:{view_class:'awy_core_view_text'},text:{view_class:'awy_core_view_text'}},observe:[],default_config:{'db/implicit_migration':true,web:{},cookie:{},modules:{awy_core:{company_name:'Awy',site_title:'Awy',copyright_message:'Awy',admin_email:'admin@example.com',support_name:'Support',support_email:'support@example.com',sales_name:'Sales',sales_email:'support@example.com',default_tz:"America/New_York",default_country:'US',base_locale:'en_US',base_currency:'USD',default_currency:'USD'}}}};$__export('default',config);}};});
...
$ctx.state=31;break;case 31:$ctx.state=(Array.isArray(themeName))?4:3;break;case 4:$__7=true;$__8=false;$__9=undefined;try{for($__5=void 0,$__4=(themeName)[Symbol.iterator]();!($__7=($__5=$__4.next()).done);$__7=true){n=$__5.value;{this.applyTheme(n);}}}catch($__10){$__8=true;$__9=$__10;}finally{try{if(!$__7&&$__4.return!=null){$__4.return();}}finally{if($__8){throw $__9;}}}
$ctx.state=5;break;case 5:$ctx.returnValue=this;$ctx.state=2;break;case 2:$ctx.state=-2;break;case 3:$ctx.state=(!(themeName in this._themes))?10:9;break;case 10:throw new Error('Invalid theme supplied: '+themeName);$ctx.state=11;break;case 11:$ctx.returnValue=this;$ctx.state=8;break;case 8:$ctx.state=-2;break;case 9:$__45=this.logger;$ctx.state=17;break;case 17:Promise.resolve($__45).then($ctx.createCallback(15),$ctx.errback);return;case 15:$__46=$ctx.value;$ctx.state=14;break;case 14:$__47=$__46.debug;$__48=$__47.call($__46,'THEME.APPLY '+themeName);$ctx.state=19;break;case 19:Promise.resolve(Class.i('awy_core_model_events')).then($ctx.createCallback(22),$ctx.errback);return;case 22:evnt=$ctx.value;$ctx.state=21;break;case 21:evnt.fire('Layout::applyTheme:before',{'theme_name':themeName});$ctx.state=33;break;case 33:Promise.resolve(this.loadTheme(themeName)).then($ctx.createCallback(24),$ctx.errback);return;case 24:Promise.resolve(this.loadLayoutFilesFromAllModules()).then($ctx.createCallback(26),$ctx.errback);return;case 26:$ctx.returnValue=this;$ctx.state=28;break;case 28:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"loadTheme",{value:$traceurRuntime.initTailRecursiveFunction(function(themeName){return $traceurRuntime.call(function(themeName){var theme,req,util,area,parentThemeName,$__7,$__8,$__9,$__5,$__4,p,evnt,modReg,layoutBefore,$__14,$__15,$__16,$__12,$__11,$__49,$__50,$__51,$__52,$__10,$__17;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
$ctx.state=74;break;case 69:evnt.fire('Layout::loadTheme:after',{'theme_name':themeName,'theme':theme});$ctx.state=90;break;case 90:$ctx.returnValue=true;$ctx.state=81;break;case 81:$ctx.state=-2;break;case 45:$ctx.state=$ctx.finallyFallThrough;break;case 74:$ctx.state=$ctx.finallyFallThrough;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"addModuleViewsDirsAndLayouts",{value:$traceurRuntime.initTailRecursiveFunction(function(module,area){return $traceurRuntime.call(function(module,area){var util,areaDir,moduleRootDir;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:Promise.resolve(Class.i('awy_core_util_misc')).then($ctx.createCallback(3),$ctx.errback);return;case 3:util=$ctx.value;$ctx.state=2;break;case 2:areaDir=area.replace('awy_','');moduleRootDir=module.root_dir;$ctx.state=13;break;case 13:$ctx.state=(util.contains(module.auto_use,'all')||util.contains(module.auto_use,'views'))?4:7;break;case 4:Promise.resolve(this.addAllViewsDir('/'+moduleRootDir+'/views')).then($ctx.createCallback(5),$ctx.errback);return;case 5:Promise.resolve(this.addAllViewsDir('/'+moduleRootDir+'/'+areaDir+'/views')).then($ctx.createCallback(7),$ctx.errback);return;case 7:if(util.contains(module.auto_use,'all')||util.contains(module.auto_use,'layout')){this.loadLayoutAfterTheme(moduleRootDir+'/layout.js');this.loadLayoutAfterTheme(moduleRootDir+'/'+areaDir+'/layout.js');}
$ctx.state=15;break;case 15:$ctx.returnValue=this;$ctx.state=10;break;case 10:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"addAllViewsDir",{value:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var rootDir,prefix,curModule,modReg;var $arguments=arguments;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
switch($ctx.state){case 0:$__53=this.logger;$ctx.state=5;break;case 5:Promise.resolve($__53).then($ctx.createCallback(3),$ctx.errback);return;case 3:$__54=$ctx.value;$ctx.state=2;break;case 2:$__55=$__54.debug;$__56=$__55.call($__54,'LAYOUT.LOAD: '+layoutFilename);$ctx.state=7;break;case 7:$ctx.pushTry(22,null);$ctx.state=25;break;case 25:Promise.resolve(System.import(layoutFilename)).then($ctx.createCallback(10),$ctx.errback);return;case 10:layoutData=$ctx.value;$ctx.state=9;break;case 9:layoutData=layoutData.default;$ctx.state=14;break;case 14:Promise.resolve(this.addLayout(layoutData)).then($ctx.createCallback(12),$ctx.errback);return;case 12:$ctx.popTry();$ctx.state=27;break;case 22:$ctx.popTry();$ctx.maybeUncatchable();e=$ctx.storedException;$ctx.state=18;break;case 18:$__57=this.logger;$ctx.state=19;break;case 19:Promise.resolve($__57).then($ctx.createCallback(17),$ctx.errback);return;case 17:$__58=$ctx.value;$ctx.state=16;break;case 16:$__59=$__58.warn;$__60=$__59.call($__58,'LAYOUT.LOAD.MISSING: '+layoutFilename);$ctx.state=27;break;case 27:$ctx.returnValue=this;$ctx.state=30;break;case 30:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"loadLayoutAfterTheme",{value:function(layoutFilename){var first=arguments[1]!==(void 0)?arguments[1]:false;if(first){this._loadLayoutFiles.unshift(layoutFilename);}else{this._loadLayoutFiles.push(layoutFilename);}
return this;},configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"loadLayoutFilesFromAllModules",{value:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var layoutFile,$__7,$__8,$__9,$__5,$__4,$__10;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:$__7=true;$__8=false;$__9=undefined;$ctx.state=25;break;case 25:$ctx.pushTry(8,9);$ctx.state=11;break;case 11:$__5=void 0,$__4=(this._loadLayoutFiles)[Symbol.iterator]();$ctx.state=7;break;case 7:$ctx.state=(!($__7=($__5=$__4.next()).done))?3:5;break;case 2:$__7=true;$ctx.state=7;break;case 3:layoutFile=$__5.value;$ctx.state=4;break;case 4:Promise.resolve(this.loadLayout(layoutFile)).then($ctx.createCallback(2),$ctx.errback);return;case 5:$ctx.popTry();$ctx.state=9;$ctx.finallyFallThrough=13;break;case 8:$ctx.popTry();$ctx.maybeUncatchable();$__10=$ctx.storedException;$ctx.state=14;break;case 14:$__8=true;$__9=$__10;$ctx.state=9;$ctx.finallyFallThrough=13;break;case 9:$ctx.popTry();$ctx.state=20;break;case 20:try{if(!$__7&&$__4.return!=null){$__4.return();}}finally{if($__8){throw $__9;}}
$ctx.state=18;break;case 13:this._loadLayoutFiles=[];$ctx.state=27;break;case 27:$ctx.returnValue=this;$ctx.state=22;break;case 22:$ctx.state=-2;break;case 18:$ctx.state=$ctx.finallyFallThrough;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"addLayout",{value:$traceurRuntime.initTailRecursiveFunction(function(layoutName){return $traceurRuntime.call(function(layoutName){var layout,l,$__61,$__62,$__63,$__64,def,$__65,$__66,$__67,$__68,$__69,$__70,$__71,$__72,$__73,$__74,$__75,$__76;var $arguments=arguments;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
$ctx.state=22;break;case 22:Promise.resolve(Class.i('awy_core_model_layout')).then($ctx.createCallback(26),$ctx.errback);return;case 26:layout=$ctx.value;$ctx.state=25;break;case 25:layout.addModuleViewsDirsAndLayouts(this,area);$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),processRouting:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var hlp,r,method,route,callback,args,name,multiple,$__7,$__8,$__9,$__5,$__4,$__10;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
