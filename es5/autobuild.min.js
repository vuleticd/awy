...
$ctx.state=46;break;case 41:$ctx.returnValue=undefined;$ctx.state=53;break;case 53:$ctx.state=-2;break;case 21:$ctx.state=$ctx.finallyFallThrough;break;case 46:$ctx.state=$ctx.finallyFallThrough;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"metaDirectiveRootCallback",{value:$traceurRuntime.initTailRecursiveFunction(function(args){return $traceurRuntime.call(function(args){var $__98,$__99,$__100,$__101,$__102;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
System.register("/app/change/frontend/layout.js",[],function($__export){"use strict";var __moduleName="/app/change/frontend/layout.js";var l;return{setters:[],execute:function(){l={base:[{hook:'footer',views:'customblock'}],"/custompage":[{include:'base'},{hook:'main',views:'custompage'}]};$__export('default',l);}};});
