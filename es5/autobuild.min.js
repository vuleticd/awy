...
var e=this._events.get(eventName)||false;if(!e){return this;}
if(typeof alias==="number"){e.observers.splice(alias,1);return this;}
var hasAlias=e.observers.find(function(element){if(element.alias==alias){return true;}
return false;})||false;if(hasAlias){e.observers.splice(e.observers.indexOf(hasAlias),1);}
...
$ctx.state=14;break;case 14:Promise.resolve(view.factory(viewFile,params)).then($ctx.createCallback(12),$ctx.errback);return;case 12:v=$ctx.value;$ctx.state=11;break;case 11:this.views[viewAlias]=v;$ctx.state=16;break;case 17:this.views[viewAlias].setParam(params);$ctx.state=16;break;case 16:$ctx.returnValue=this;$ctx.state=21;break;case 21:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"render",{value:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var routeName,args,rootView,eventsInstance,hookRes,result,$__29,$__30,$__31,$__32,$__33,$__34,$__35,$__36,$__37,$__38,$__39,$__40,$__41;var $arguments=arguments;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:routeName=$arguments[0]!==(void 0)?$arguments[0]:null;args=$arguments[1]!==(void 0)?$arguments[1]:{};rootView=this.rootView;$ctx.state=36;break;case 36:$__29=this.logger;$ctx.state=5;break;case 5:Promise.resolve($__29).then($ctx.createCallback(3),$ctx.errback);return;case 3:$__30=$ctx.value;$ctx.state=2;break;case 2:$__31=$__30.debug;$__32=$__31.call($__30,'LAYOUT.RENDER ');$ctx.state=7;break;case 7:$__33=this.logger;$ctx.state=12;break;case 12:Promise.resolve($__33).then($ctx.createCallback(10),$ctx.errback);return;case 10:$__34=$ctx.value;$ctx.state=9;break;case 9:$__35=$__34.debug;$__36=$__35.call($__34,rootView);$ctx.state=14;break;case 14:$ctx.state=(!rootView)?18:21;break;case 18:$__37=this.logger;$ctx.state=19;break;case 19:Promise.resolve($__37).then($ctx.createCallback(17),$ctx.errback);return;case 17:$__38=$ctx.value;$ctx.state=16;break;case 16:$__39=$__38.error;$__40=this._rootViewName;$__41=$__39.call($__38,'Main view not found: '+$__40);$ctx.state=21;break;case 21:Promise.resolve(Class.i('awy_core_model_events')).then($ctx.createCallback(25),$ctx.errback);return;case 25:eventsInstance=$ctx.value;$ctx.state=24;break;case 24:Promise.resolve(eventsInstance.fire('Layout::hook:head',args)).then($ctx.createCallback(28),$ctx.errback);return;case 28:hookRes=$ctx.value;$ctx.state=27;break;case 27:Promise.resolve(this.rootView.render(args)).then($ctx.createCallback(31),$ctx.errback);return;case 31:result=$ctx.value;$ctx.state=30;break;case 30:$ctx.returnValue=result;$ctx.state=33;break;case 33:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"updateTheme",{value:$traceurRuntime.initTailRecursiveFunction(function(themeName,params){return $traceurRuntime.call(function(themeName,params){var curModName=arguments[2]!==(void 0)?arguments[2]:null;return $traceurRuntime.continuation(this.addTheme,this,[themeName,params,curModName]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"addTheme",{value:$traceurRuntime.initTailRecursiveFunction(function(themeName,params){return $traceurRuntime.call(function(themeName,params){var curModName,modReg,paramsCopy,$__42,$__43,$__44,$__45;var $arguments=arguments;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
$ctx.state=17;break;case 17:$__42=this.logger;$ctx.state=8;break;case 8:Promise.resolve($__42).then($ctx.createCallback(6),$ctx.errback);return;case 6:$__43=$ctx.value;$ctx.state=5;break;case 5:$__44=$__43.debug;$__45=$__44.call($__43,'Adding theme '+themeName+' from module '+curModName);$ctx.state=10;break;case 10:paramsCopy=JSON.parse(JSON.stringify(params));['area','parent','layout_before','layout_after','views_before','views_after'].forEach(function(t){if(t in paramsCopy&&t!=='area'&&t!=='parent'){if(!Array.isArray(paramsCopy[t])){paramsCopy[t]=[paramsCopy[t]];}else{paramsCopy[t]=paramsCopy[t];}
paramsCopy[t].forEach(function(v,i){if(v[0]!=='@'){paramsCopy[t][i]='@'+curModName+'/'+v;}});}});if(!(themeName in this._themes)){console.log('PARAMS COPY: ',JSON.parse(JSON.stringify(this._themes)),JSON.parse(JSON.stringify(paramsCopy)));this._themes[themeName]=paramsCopy;}else{console.log('PARAMS COPY: ',JSON.parse(JSON.stringify(this._themes[themeName])),JSON.parse(JSON.stringify(paramsCopy)));this._themes[themeName]=this.objectMerge(this._themes[themeName],paramsCopy);}
$ctx.state=19;break;case 19:$ctx.returnValue=this._themes[themeName];$ctx.state=12;break;case 12:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"applyTheme",{value:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var themeName,n,$__7,$__8,$__9,$__5,$__4,evnt,$__46,$__47,$__48,$__49;var $arguments=arguments;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
$ctx.state=5;break;case 5:$ctx.returnValue=this;$ctx.state=2;break;case 2:$ctx.state=-2;break;case 3:$ctx.state=(!(themeName in this._themes))?10:9;break;case 10:throw new Error('Invalid theme supplied: '+themeName);$ctx.state=11;break;case 11:$ctx.returnValue=this;$ctx.state=8;break;case 8:$ctx.state=-2;break;case 9:$__46=this.logger;$ctx.state=17;break;case 17:Promise.resolve($__46).then($ctx.createCallback(15),$ctx.errback);return;case 15:$__47=$ctx.value;$ctx.state=14;break;case 14:$__48=$__47.debug;$__49=$__48.call($__47,'THEME.APPLY '+themeName);$ctx.state=19;break;case 19:Promise.resolve(Class.i('awy_core_model_events')).then($ctx.createCallback(22),$ctx.errback);return;case 22:evnt=$ctx.value;$ctx.state=21;break;case 21:evnt.fire('Layout::applyTheme:before',{'theme_name':themeName});$ctx.state=31;break;case 31:Promise.resolve(this.loadTheme(themeName)).then($ctx.createCallback(24),$ctx.errback);return;case 24:$ctx.returnValue=this;$ctx.state=26;break;case 26:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"loadTheme",{value:$traceurRuntime.initTailRecursiveFunction(function(themeName){return $traceurRuntime.call(function(themeName){var theme,req,util,area,parentThemeName,$__7,$__8,$__9,$__5,$__4,p,evnt,modReg,layoutBefore,$__14,$__15,$__16,$__12,$__11,$__50,$__51,$__52,$__53,$__10,$__17;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
switch($ctx.state){case 0:rootDir=$arguments[0]!==(void 0)?$arguments[0]:null;prefix=$arguments[1]!==(void 0)?$arguments[1]:'';curModule=$arguments[2]!==(void 0)?$arguments[2]:null;$ctx.state=11;break;case 11:$ctx.state=(!curModule)?1:5;break;case 1:Promise.resolve(Class.i('awy_core_model_module_registry')).then($ctx.createCallback(3),$ctx.errback);return;case 3:modReg=$ctx.value;$ctx.state=2;break;case 2:curModule=modReg.currentModuleName();$ctx.state=5;break;case 5:this._addViewsDirs.push([rootDir,prefix,curModule]);$ctx.state=13;break;case 13:$ctx.returnValue=this;$ctx.state=8;break;case 8:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"loadLayout",{value:$traceurRuntime.initTailRecursiveFunction(function(layoutFilename){return $traceurRuntime.call(function(layoutFilename){var layoutData,$__54,$__55,$__56,$__57,$__58,$__59,$__60,$__61,e;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:$__54=this.logger;$ctx.state=5;break;case 5:Promise.resolve($__54).then($ctx.createCallback(3),$ctx.errback);return;case 3:$__55=$ctx.value;$ctx.state=2;break;case 2:$__56=$__55.debug;$__57=$__56.call($__55,'LAYOUT.LOAD: '+layoutFilename);$ctx.state=7;break;case 7:$ctx.pushTry(22,null);$ctx.state=25;break;case 25:Promise.resolve(System.import(layoutFilename)).then($ctx.createCallback(10),$ctx.errback);return;case 10:layoutData=$ctx.value;$ctx.state=9;break;case 9:layoutData=layoutData.default;$ctx.state=14;break;case 14:Promise.resolve(this.addLayout(layoutData)).then($ctx.createCallback(12),$ctx.errback);return;case 12:$ctx.popTry();$ctx.state=27;break;case 22:$ctx.popTry();$ctx.maybeUncatchable();e=$ctx.storedException;$ctx.state=18;break;case 18:$__58=this.logger;$ctx.state=19;break;case 19:Promise.resolve($__58).then($ctx.createCallback(17),$ctx.errback);return;case 17:$__59=$ctx.value;$ctx.state=16;break;case 16:$__60=$__59.warn;$__61=$__60.call($__59,'LAYOUT.LOAD.MISSING: '+e);$ctx.state=27;break;case 27:$ctx.returnValue=this;$ctx.state=30;break;case 30:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"addLayout",{value:$traceurRuntime.initTailRecursiveFunction(function(layoutName){return $traceurRuntime.call(function(layoutName){var layout,util,l,$__62,$__63,$__64,$__65,def,current,$__14,$__15,$__16,$__7,$__8,$__9,$__28,$__12,$__11,$__66,$__67,$__68,$__69,$__70,$__71,$__72,$__73,$__74,$__75,$__76,$__77;var $arguments=arguments;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:layout=$arguments[1]!==(void 0)?$arguments[1]:null;$ctx.state=53;break;case 53:Promise.resolve(Class.i('awy_core_util_misc')).then($ctx.createCallback(3),$ctx.errback);return;case 3:util=$ctx.value;$ctx.state=2;break;case 2:$ctx.state=((typeof layoutName==='undefined'?'undefined':$traceurRuntime.typeof(layoutName))==="object")?16:20;break;case 16:$__62=[];$__63=layoutName;for($__64 in $__63)
$__62.push($__64);$ctx.state=17;break;case 17:$__65=0;$ctx.state=15;break;case 15:$ctx.state=($__65<$__62.length)?9:13;break;case 5:$__65++;$ctx.state=15;break;case 9:l=$__62[$__65];$ctx.state=10;break;case 10:$ctx.state=(!(l in $__63))?5:7;break;case 7:def=layoutName[l];$ctx.state=12;break;case 12:Promise.resolve(this.addLayout(l,def)).then($ctx.createCallback(5),$ctx.errback);return;case 13:$ctx.returnValue=this;$ctx.state=19;break;case 19:$ctx.state=-2;break;case 20:$ctx.state=(!Array.isArray(layout))?25:47;break;case 25:$__66=this.logger;$ctx.state=26;break;case 26:Promise.resolve($__66).then($ctx.createCallback(24),$ctx.errback);return;case 24:$__67=$ctx.value;$ctx.state=23;break;case 23:$__68=$__67.debug;$__69=$__68.call($__67,'LAYOUT.INVALID_OR_EMPTY '+layoutName);$ctx.state=28;break;case 47:$ctx.state=(!this._layouts.has(layoutName))?32:41;break;case 32:$__70=this.logger;$ctx.state=33;break;case 33:Promise.resolve($__70).then($ctx.createCallback(31),$ctx.errback);return;case 31:$__71=$ctx.value;$ctx.state=30;break;case 30:$__72=$__71.debug;$__73=$__72.call($__71,'LAYOUT.ADD '+layoutName);$ctx.state=35;break;case 35:this._layouts.set(layoutName,layout);$ctx.state=28;break;case 41:$__74=this.logger;$ctx.state=42;break;case 42:Promise.resolve($__74).then($ctx.createCallback(40),$ctx.errback);return;case 40:$__75=$ctx.value;$ctx.state=39;break;case 39:$__76=$__75.warn;$__77=$__76.call($__75,'LAYOUT.UPDATE '+layoutName);$ctx.state=44;break;case 44:current=this._layouts.get(layoutName);$__14=true;$__15=false;$__16=undefined;try{$__28=function(){var directive=$__12.value;{if('hook'in directive){var oldDirective=current.find(function(element){if('hook'in element&&element.hook==directive.hook){return true;}
return false;})||false;if(!oldDirective){}else{var directiveArgument;$__7=true;$__8=false;$__9=undefined;try{for(var $__5=void 0,$__4=(['clear','views','text'])[Symbol.iterator]();!($__7=($__5=$__4.next()).done);$__7=true){directiveArgument=$__5.value;{if(directiveArgument in directive){if(directiveArgument in oldDirective){oldDirective[directiveArgument]=util.arrayMergeRecursive([oldDirective[directiveArgument],directive[directiveArgument]]);}else{oldDirective[directiveArgument]=directive[directiveArgument];}}}}}catch($__10){$__8=true;$__9=$__10;}finally{try{if(!$__7&&$__4.return!=null){$__4.return();}}finally{if($__8){throw $__9;}}}}}}};for($__12=void 0,$__11=(layout)[Symbol.iterator]();!($__14=($__12=$__11.next()).done);$__14=true){$__28();}}catch($__17){$__15=true;$__16=$__17;}finally{try{if(!$__14&&$__11.return!=null){$__11.return();}}finally{if($__15){throw $__16;}}}
$ctx.state=28;break;case 28:$ctx.returnValue=this;$ctx.state=50;break;case 50:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"applyLayout",{value:$traceurRuntime.initTailRecursiveFunction(function(layoutName){return $traceurRuntime.call(function(layoutName){var util,callbacks,d,$__7,$__8,$__9,$__5,$__4,r,clbClass,exists,key,callback,cb,$__14,$__15,$__16,$__12,$__11,$__78,$__79,$__80,$__81,$__82,$__83,$__84,$__85,$__86,$__87,$__88,$__89,$__10,$__17;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:$ctx.state=(!this._layouts.has(layoutName))?4:10;break;case 4:$__78=this.logger;$ctx.state=5;break;case 5:Promise.resolve($__78).then($ctx.createCallback(3),$ctx.errback);return;case 3:$__79=$ctx.value;$ctx.state=2;break;case 2:$__80=$__79.debug;$__81=$__80.call($__79,'LAYOUT.EMPTY '+layoutName);$ctx.state=7;break;case 7:$ctx.returnValue=this;$ctx.state=9;break;case 9:$ctx.state=-2;break;case 10:$__82=this.logger;$ctx.state=16;break;case 16:Promise.resolve($__82).then($ctx.createCallback(14),$ctx.errback);return;case 14:$__83=$ctx.value;$ctx.state=13;break;case 13:$__84=$__83.debug;$__85=$__84.call($__83,'LAYOUT.APPLY '+layoutName);$ctx.state=18;break;case 18:Promise.resolve(Class.i('awy_core_util_misc')).then($ctx.createCallback(21),$ctx.errback);return;case 21:util=$ctx.value;$ctx.state=20;break;case 20:callbacks=[];$__7=true;$__8=false;$__9=undefined;$ctx.state=105;break;case 105:$ctx.pushTry(66,67);$ctx.state=69;break;case 69:$__5=void 0,$__4=(this._layouts.get(layoutName))[Symbol.iterator]();$ctx.state=65;break;case 65:$ctx.state=(!($__7=($__5=$__4.next()).done))?61:63;break;case 52:$__7=true;$ctx.state=65;break;case 61:d=$__5.value;$ctx.state=62;break;case 62:d['layout_name']=layoutName;$ctx.state=58;break;case 58:$ctx.state=('if'in d)?31:29;break;case 31:r=d['if'].split('.');$ctx.state=32;break;case 32:Promise.resolve(Class.i(r[0])).then($ctx.createCallback(24),$ctx.errback);return;case 24:clbClass=$ctx.value;$ctx.state=23;break;case 23:Promise.resolve(this.methodExists(clbClass,r[1])).then($ctx.createCallback(27),$ctx.errback);return;case 27:exists=$ctx.value;$ctx.state=26;break;case 26:$ctx.state=(!exists||!clbClass[r[1]]())?52:29;break;case 29:$ctx.state=(!('type'in d))?39:42;break;case 39:key=Object.keys(this._metaDirectives).find($traceurRuntime.initTailRecursiveFunction(function(element,index,array){return $traceurRuntime.call(function(element,index,array){return $traceurRuntime.continuation(util.contains,util,[Object.keys(d),element]);},this,arguments);}),this);$ctx.state=40;break;case 40:$ctx.state=(!(key in this._metaDirectives))?36:35;break;case 36:throw new Error('Unknown layout directive: ');$ctx.state=52;break;case 35:d['type']=key.trim();d['name']=d[key].trim();$ctx.state=42;break;case 42:callback=this._metaDirectives[d['type']];$ctx.state=60;break;case 60:$ctx.state=(d['type']==='remove')?53:54;break;case 53:$ctx.state=(d['name']==='ALL')?47:52;break;case 47:$__86=this.logger;$ctx.state=48;break;case 48:Promise.resolve($__86).then($ctx.createCallback(46),$ctx.errback);return;case 46:$__87=$ctx.value;$ctx.state=45;break;case 45:$__88=$__87.debug;$__89=$__88.call($__87,'LAYOUT.REMOVE ALL');$ctx.state=50;break;case 50:callbacks=[];$ctx.state=52;break;case 54:callbacks.push([callback,d]);$ctx.state=52;break;case 63:$ctx.popTry();$ctx.state=67;$ctx.finallyFallThrough=71;break;case 66:$ctx.popTry();$ctx.maybeUncatchable();$__10=$ctx.storedException;$ctx.state=72;break;case 72:$__8=true;$__9=$__10;$ctx.state=67;$ctx.finallyFallThrough=71;break;case 67:$ctx.popTry();$ctx.state=78;break;case 78:try{if(!$__7&&$__4.return!=null){$__4.return();}}finally{if($__8){throw $__9;}}
...
$ctx.state=98;break;case 93:$ctx.returnValue=this;$ctx.state=102;break;case 102:$ctx.state=-2;break;case 76:$ctx.state=$ctx.finallyFallThrough;break;case 98:$ctx.state=$ctx.finallyFallThrough;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"hookView",{value:$traceurRuntime.initTailRecursiveFunction(function(hookName,viewName){return $traceurRuntime.call(function(hookName,viewName){var args,params,viewParams,view,p,$__90,$__91,$__92,$__93;var $arguments=arguments;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:args=$arguments[2]!==(void 0)?$arguments[2]:{};params=$arguments[3]!==(void 0)?$arguments[3]:{};$ctx.state=23;break;case 23:$ctx.state=(Array.isArray(viewName))?3:2;break;case 3:viewParams=viewName;viewName=viewParams.shift();$ctx.state=4;break;case 4:Promise.resolve(this.addView(viewName,viewParams)).then($ctx.createCallback(2),$ctx.errback);return;case 2:view=this.view(viewName);$ctx.state=25;break;case 25:$ctx.state=(!view)?9:15;break;case 9:$__90=this.logger;$ctx.state=10;break;case 10:Promise.resolve($__90).then($ctx.createCallback(8),$ctx.errback);return;case 8:$__91=$ctx.value;$ctx.state=7;break;case 7:$__92=$__91.warn;$__93=$__92.call($__91,'Invalid view name: '+viewName);$ctx.state=12;break;case 12:$ctx.returnValue=this;$ctx.state=14;break;case 14:$ctx.state=-2;break;case 15:p={};if(!('alias'in params)){p['alias']=viewName;}
$ctx.state=27;break;case 27:Promise.resolve(this.hook(hookName,view,args,p)).then($ctx.createCallback(18),$ctx.errback);return;case 18:$ctx.returnValue=this;$ctx.state=20;break;case 20:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"hookClear",{value:$traceurRuntime.initTailRecursiveFunction(function(hookName,viewNames){return $traceurRuntime.call(function(hookName,viewNames){var evtHlp,util,eventName,clearViewName,$__7,$__8,$__9,$__5,$__4;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:Promise.resolve(Class.i('awy_core_model_events')).then($ctx.createCallback(3),$ctx.errback);return;case 3:evtHlp=$ctx.value;$ctx.state=2;break;case 2:Promise.resolve(Class.i('awy_core_util_misc')).then($ctx.createCallback(6),$ctx.errback);return;case 6:util=$ctx.value;$ctx.state=5;break;case 5:eventName='Layout::hook:'+hookName;if(true===viewNames||'ALL'===viewNames){evtHlp.off(eventName,true);}else{viewNames=util.arrayMergeRecursive([[],viewNames]);if(Array.isArray(viewNames)){$__7=true;$__8=false;$__9=undefined;try{for($__5=void 0,$__4=(viewNames)[Symbol.iterator]();!($__7=($__5=$__4.next()).done);$__7=true){clearViewName=$__5.value;{evtHlp.off(eventName,clearViewName);}}}catch($__10){$__8=true;$__9=$__10;}finally{try{if(!$__7&&$__4.return!=null){$__4.return();}}finally{if($__8){throw $__9;}}}}}
$ctx.state=11;break;case 11:$ctx.returnValue=this;$ctx.state=8;break;case 8:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"hook",{value:$traceurRuntime.initTailRecursiveFunction(function(hookName,callback){return $traceurRuntime.call(function(hookName,callback){var args,params,evt;var $arguments=arguments;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
switch($ctx.state){case 0:hookArgs=args['args']||{};params=args['params']||{};$ctx.state=59;break;case 59:$ctx.state=('views'in args)?24:27;break;case 24:if(!Array.isArray(args.views)){args.views=[args.views];}
...
$ctx.state=27;break;case 27:$ctx.state=('clear'in args)?29:30;break;case 29:Promise.resolve(this.hookClear(args.name,args['clear'])).then($ctx.createCallback(30),$ctx.errback);return;case 30:$ctx.state=('text'in args)?52:44;break;case 52:if(!Array.isArray(args.text)){args.text=[args.text];}
$__14=true;$__15=false;$__16=undefined;$ctx.state=53;break;case 53:$ctx.pushTry(39,40);$ctx.state=42;break;case 42:$__12=void 0,$__11=(args.text)[Symbol.iterator]();$ctx.state=38;break;case 38:$ctx.state=(!($__14=($__12=$__11.next()).done))?34:36;break;case 33:$__14=true;$ctx.state=38;break;case 34:t=$__12.value;$ctx.state=35;break;case 35:Promise.resolve(this.hook(args.name,function(obj){return obj.text||'';},{text:t})).then($ctx.createCallback(33),$ctx.errback);return;case 36:$ctx.popTry();$ctx.state=40;$ctx.finallyFallThrough=44;break;case 39:$ctx.popTry();$ctx.maybeUncatchable();$__17=$ctx.storedException;$ctx.state=45;break;case 45:$__15=true;$__16=$__17;$ctx.state=40;$ctx.finallyFallThrough=44;break;case 40:$ctx.popTry();$ctx.state=51;break;case 51:try{if(!$__14&&$__11.return!=null){$__11.return();}}finally{if($__15){throw $__16;}}
$ctx.state=49;break;case 44:$ctx.returnValue=undefined;$ctx.state=56;break;case 56:$ctx.state=-2;break;case 21:$ctx.state=$ctx.finallyFallThrough;break;case 49:$ctx.state=$ctx.finallyFallThrough;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"metaDirectiveRootCallback",{value:$traceurRuntime.initTailRecursiveFunction(function(args){return $traceurRuntime.call(function(args){var $__98,$__99,$__100,$__101,$__102;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:this.rootView=args['name'];$ctx.state=9;break;case 9:$__98=this.logger;$ctx.state=5;break;case 5:Promise.resolve($__98).then($ctx.createCallback(3),$ctx.errback);return;case 3:$__99=$ctx.value;$ctx.state=2;break;case 2:$__100=$__99.debug;$__101=args['name'];$__102=$__100.call($__99,'SET ROOT VIEW: '+$__101);$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"metaDirectiveCallback",{value:$traceurRuntime.initTailRecursiveFunction(function(args){return $traceurRuntime.call(function(args){return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
switch($ctx.state){case 0:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),configurable:true,enumerable:true,writable:true}),Object.defineProperty($__3,"objectMerge",{value:function(){var $__27;for(var rest=[],$__25=0;$__25<arguments.length;$__25++)
rest[$__25]=arguments[$__25];var base=rest.shift();var $__14=true;var $__15=false;var $__16=undefined;try{for(var $__12=void 0,$__11=(rest)[Symbol.iterator]();!($__14=($__12=$__11.next()).done);$__14=true){var append=$__12.value;{if((typeof base==='undefined'?'undefined':$traceurRuntime.typeof(base))!=='object'){return append;}
...
($__27=base).push.apply($__27,$traceurRuntime.spread(append));break;}
...
switch($ctx.state){case 0:$ctx.state=(this.run_status!==PENDING)?1:3;break;case 1:$ctx.returnValue=undefined;$ctx.state=2;break;case 2:$ctx.state=-2;break;case 3:this.processAutoload();this.processTranslations();$ctx.state=58;break;case 58:Promise.resolve(this.processViews()).then($ctx.createCallback(6),$ctx.errback);return;case 6:Promise.resolve(this.processRouting()).then($ctx.createCallback(8),$ctx.errback);return;case 8:Promise.resolve(this.processObserve()).then($ctx.createCallback(10),$ctx.errback);return;case 10:$ctx.state=('bootstrap'in this)?14:50;break;case 14:$__51=this.logger;$ctx.state=15;break;case 15:Promise.resolve($__51).then($ctx.createCallback(13),$ctx.errback);return;case 13:$__52=$ctx.value;$ctx.state=12;break;case 12:$__53=$__52.debug;$__54=this.module_name;$__55=$__53.call($__52,'Start bootstrap callback for '+$__54);$ctx.state=17;break;case 17:$__7=true;$__8=false;$__9=undefined;$ctx.state=52;break;case 52:$ctx.pushTry(31,32);$ctx.state=34;break;case 34:$__5=void 0,$__4=(this.bootstrap)[Symbol.iterator]();$ctx.state=30;break;case 30:$ctx.state=(!($__7=($__5=$__4.next()).done))?26:28;break;case 22:$__7=true;$ctx.state=30;break;case 26:b=$__5.value;$ctx.state=27;break;case 27:$ctx.state=('callback'in b)?23:22;break;case 23:className=b.callback.split(".")[0];method=b.callback.split(".")[1];$ctx.state=24;break;case 24:Promise.resolve(Class.i(className)).then($ctx.createCallback(20),$ctx.errback);return;case 20:clbClass=$ctx.value;$ctx.state=19;break;case 19:Promise.resolve(clbClass[method]()).then($ctx.createCallback(22),$ctx.errback);return;case 28:$ctx.popTry();$ctx.state=32;$ctx.finallyFallThrough=36;break;case 31:$ctx.popTry();$ctx.maybeUncatchable();$__10=$ctx.storedException;$ctx.state=37;break;case 37:$__8=true;$__9=$__10;$ctx.state=32;$ctx.finallyFallThrough=36;break;case 32:$ctx.popTry();$ctx.state=43;break;case 43:try{if(!$__7&&$__4.return!=null){$__4.return();}}finally{if($__8){throw $__9;}}
$ctx.state=41;break;case 36:$__56=this.logger;$ctx.state=48;break;case 48:Promise.resolve($__56).then($ctx.createCallback(46),$ctx.errback);return;case 46:$__57=$ctx.value;$ctx.state=45;break;case 45:$__58=$__57.debug;$__59=this.module_name;$__60=$__58.call($__57,'End bootstrap callback for '+$__59);$ctx.state=50;break;case 50:this.run_status=LOADED;$ctx.state=60;break;case 60:$ctx.returnValue=this;$ctx.state=55;break;case 55:$ctx.state=-2;break;case 41:$ctx.state=$ctx.finallyFallThrough;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),processAutoload:function(){if('autoload'in this){var al;var $__7=true;var $__8=false;var $__9=undefined;try{for(var $__5=void 0,$__4=(this.autoload)[Symbol.iterator]();!($__7=($__5=$__4.next()).done);$__7=true){al=$__5.value;{}}}catch($__10){$__8=true;$__9=$__10;}finally{try{if(!$__7&&$__4.return!=null){$__4.return();}}finally{if($__8){throw $__9;}}}}},processTranslations:function(){if('translations'in this){var tr=this.translations['en'];var file='/app/'+this.root_dir+"/i18n/"+tr;}},processViews:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var layout,$__61,$__62,$__63,$__64,v,$__65,$__66,$__67,$__68,$__69,$__70,$__71,$__72;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
...
switch($ctx.state){case 0:params=$arguments[1]!==(void 0)?$arguments[1]:{};params['view_name']=viewName;className=params.view_class||this._origClass.toLowerCase();$ctx.state=8;break;case 8:Promise.resolve(ClassRegistry.getInstance(className,false,params)).then($ctx.createCallback(3),$ctx.errback);return;case 3:view=$ctx.value;$ctx.state=2;break;case 2:$ctx.returnValue=view;$ctx.state=5;break;case 5:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),setParam:function(key){var value=arguments[1]!==(void 0)?arguments[1]:null;if((typeof key==='undefined'?'undefined':$traceurRuntime.typeof(key))==='object'){var k;for(k in key){this.setParam(k,key[k]);}
return this;}
...
switch(operator){case'>':case'gt':return(compare>0);case'>=':case'ge':return(compare>=0);case'<=':case'le':return(compare<=0);case'==':case'=':case'eq':return(compare===0);case'<>':case'!=':case'ne':return(compare!==0);case'':case'<':case'lt':return(compare<0);default:return null;}},prepVersion:$traceurRuntime.initTailRecursiveFunction(function(v){return $traceurRuntime.call(function(v){v=(''+v).replace(/[_\-+]/g,'.');v=v.replace(/([^.\d]+)/g,'.$1.').replace(/\.{2,}/g,'.');return(!v.length?[-8]:$traceurRuntime.continuation(v.split,v,['.']));},this,arguments);}),numVersion:$traceurRuntime.initTailRecursiveFunction(function(v){return $traceurRuntime.call(function(v){return!v?0:(isNaN(v)?this.vm(v)||-7:$traceurRuntime.continuation(parseInt,null,[v,10]));},this,arguments);}),vm:function(v){switch(v){case'dev':return-6;break;case'alpha':case'a':return-5;break;case'beta':case'b':return-4;break;case'RC':case'rc':return-3;break;case'#':return-2;break;case'p':case'pl':return 1;break;}},arrayMergeRecursive:function(args){var $__2;var res=$traceurRuntime.spread(new Set(($__2=Array.prototype).concat.apply($__2,$traceurRuntime.spread(args))));return res;}},{},$__super]);},this,arguments);})(Class);$__export('default',Awy_Core_Util_Misc);}};});
System.register("/app/awy/core/util/pace.js",[],function($__export){"use strict";var __moduleName="/app/awy/core/util/pace.js";var Awy_Core_Util_Pace;return{setters:[],execute:function(){Awy_Core_Util_Pace=$traceurRuntime.initTailRecursiveFunction(function($__super){return $traceurRuntime.call(function($__super){function Awy_Core_Util_Pace(host){$traceurRuntime.superConstructor(Awy_Core_Util_Pace).call(this);this._host=host||null;if(this._host){this.css_raw(['media=screen','title=pace']);this.css_rule(['pace','div#pace','display: block; position:absolute; top: 0; left: 0; z-index: 100; width: 100%; height: 100%; background-color: rgba(192, 192, 192, 0.5); background-image: url("http://i.stack.imgur.com/MnyxU.gif"); background-repeat: no-repeat; background-position: center;']);var loader=document.createRange().createContextualFragment("<div id=\"pace\"></div>");this._host.appendChild(loader);}}
return $traceurRuntime.continuation($traceurRuntime.createClass,$traceurRuntime,[Awy_Core_Util_Pace,{css_raw:function(args){var style=document.createElement("style");var st;var $__5=true;var $__6=false;var $__7=undefined;try{for(var $__3=void 0,$__2=(args)[Symbol.iterator]();!($__5=($__3=$__2.next()).done);$__5=true){st=$__3.value;{var path=st.split('=');if(path.length==2){style.setAttribute(path[0],path[1]);}}}}catch($__8){$__6=true;$__7=$__8;}finally{try{if(!$__5&&$__2.return!=null){$__2.return();}}finally{if($__6){throw $__7;}}}
style.appendChild(document.createTextNode(""));document.head.appendChild(style);return style.sheet;},css_rule:function(args){var title=args.shift();var selector=args.shift();var rules=args.shift();var index=0;var sheets=Array.from(document.styleSheets);var sheet=sheets.find(function(element,index,array){return element.title==title;});if(!sheet){sheet=this.css_raw([]);}
if("insertRule"in sheet){index=args.shift()||0;sheet.insertRule(selector+"{"+rules+"}",index);}else if("addRule"in sheet){index=args.shift()||-1;sheet.addRule(selector,rules,index);}}},{},$__super]);},this,arguments);})(Class);$__export('default',Awy_Core_Util_Pace);}};});
...
switch($ctx.state){case 0:$ctx.pushTry(20,null);$ctx.state=23;break;case 23:Promise.resolve(this.ready(window)).then($ctx.createCallback(3),$ctx.errback);return;case 3:doc=$ctx.value;$ctx.state=2;break;case 2:appHost=doc.querySelectorAll('[distro]');$ctx.state=10;break;case 10:Promise.resolve(Class.i('awy_core_model_app')).then($ctx.createCallback(6),$ctx.errback);return;case 6:app=$ctx.value;$ctx.state=5;break;case 5:app.host=appHost[0];$ctx.state=12;break;case 12:Promise.resolve(app.run(area)).then($ctx.createCallback(8),$ctx.errback);return;case 8:$ctx.popTry();$ctx.state=-2;break;case 20:$ctx.popTry();$ctx.maybeUncatchable();error=$ctx.storedException;$ctx.state=16;break;case 16:$__2=this.logger;$ctx.state=17;break;case 17:Promise.resolve($__2).then($ctx.createCallback(15),$ctx.errback);return;case 15:$__3=$ctx.value;$ctx.state=14;break;case 14:$__4=$__3.error;$__5=$__4.call($__3,error);$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);})},{},$__super]);},this,arguments);})(Class);;$__export('default',Bootstrap);}};});
System.register("/app/change/frontend/controller.js",["awy/core/controller/abstract.js"],function($__export){"use strict";var __moduleName="/app/change/frontend/controller.js";var Awy_Core_Controller_Abstract,ChangedFrontendController;return{setters:[function($__m){Awy_Core_Controller_Abstract=$__m.default;}],execute:function(){ChangedFrontendController=$traceurRuntime.initTailRecursiveFunction(function($__super){return $traceurRuntime.call(function($__super){function ChangedFrontendController(){$traceurRuntime.superConstructor(ChangedFrontendController).call(this);}
return $traceurRuntime.continuation($traceurRuntime.createClass,$traceurRuntime,[ChangedFrontendController,{action_custompage:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:console.log('ChangedFrontendController.action_custompage');$ctx.state=4;break;case 4:Promise.resolve(this.layout("/custompage")).then($ctx.createCallback(-2),$ctx.errback);return;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);})},{},$__super]);},this,arguments);})(Awy_Core_Controller_Abstract);$__export('default',ChangedFrontendController);}};});
System.register("/app/change/frontend/layout.js",[],function($__export){"use strict";var __moduleName="/app/change/frontend/layout.js";var l;return{setters:[],execute:function(){l={base:[{hook:'footer',views:'customblock'}],"/custompage":[{include:'base'},{hook:'footer',clear:'footer'},{hook:'main',views:'custompage'}]};$__export('default',l);}};});
System.register("/app/change/frontend/manifest.js",[],function($__export){"use strict";var __moduleName="/app/change/frontend/manifest.js";var c;return{setters:[],execute:function(){c={module_name:'change_frontend',version:'0.0.0.1',description:"Frontend changes demo",require:{module:{distro_frontend:'0.0.0.1'}},areas:{distro_frontend:{views:{"custompage":{},"customblock":{view_class:'change_frontend_view_customblock'}},routing:[['/custompage','change_frontend_controller.custompage']]}},themes:{distro_frontend_defaultTheme:{layout_before:'layout.js'}}};$__export('default',c);}};});
System.register("/app/change/frontend/view/customblock.js",["awy/core/model/view.js"],function($__export){"use strict";var __moduleName="/app/change/frontend/view/customblock.js";var Awy_Core_Model_View,Changed_View;return{setters:[function($__m){Awy_Core_Model_View=$__m.default;}],execute:function(){Changed_View=$traceurRuntime.initTailRecursiveFunction(function($__super){return $traceurRuntime.call(function($__super){function Changed_View(params){$traceurRuntime.superConstructor(Changed_View).call(this);this._params=params;}
return $traceurRuntime.continuation($traceurRuntime.createClass,$traceurRuntime,[Changed_View,{forwardToCustomPage:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var r;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:Promise.resolve(Class.i('awy_core_model_router')).then($ctx.createCallback(3),$ctx.errback);return;case 3:r=$ctx.value;$ctx.state=2;break;case 2:r.navigate('custompage');$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);})},{},$__super]);},this,arguments);})(Awy_Core_Model_View);$__export('default',Changed_View);}};});
System.register("/app/change/frontend/views/customblock.js",[],function($__export){"use strict";var __moduleName="/app/change/frontend/views/customblock.js";var str;return{setters:[],execute:function(){str="\n<div class=\"row\">\n\t<div class=\"centered\"><i>&copy; 2016 <a data-bind=\"click forwardToCustomPage\" href=\"javascript:void(0);\">forwardToCustomPage</a> All rights changed.</i></div>\n</div>\n";$__export('default',str);}};});
System.register("/app/change/frontend/views/custompage.js",[],function($__export){"use strict";var __moduleName="/app/change/frontend/views/custompage.js";var str;return{setters:[],execute:function(){str="\n<div class=\"row\">\n\t<h1>Changed Homepage.</h1>\n</div>\n";$__export('default',str);}};});
...
System.register("/app/distro/install/controller.js",["awy/core/controller/abstract.js"],function($__export){"use strict";var __moduleName="/app/distro/install/controller.js";var Abstract,InstallController;return{setters:[function($__m){Abstract=$__m.default;}],execute:function(){InstallController=$traceurRuntime.initTailRecursiveFunction(function($__super){return $traceurRuntime.call(function($__super){function InstallController(){$traceurRuntime.superConstructor(InstallController).call(this);}
return $traceurRuntime.continuation($traceurRuntime.createClass,$traceurRuntime,[InstallController,{onBeforeDispatch:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var req,l;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:$ctx.state=(!$traceurRuntime.superGet(this,InstallController.prototype,"onBeforeDispatch").call(this))?1:3;break;case 1:$ctx.returnValue=false;$ctx.state=2;break;case 2:$ctx.state=-2;break;case 3:Promise.resolve(Class.i('awy_core_model_router_request')).then($ctx.createCallback(7),$ctx.errback);return;case 7:req=$ctx.value;$ctx.state=6;break;case 6:Promise.resolve(Class.i('awy_core_model_layout')).then($ctx.createCallback(10),$ctx.errback);return;case 10:l=$ctx.value;$ctx.state=9;break;case 9:Promise.resolve(l.applyTheme('distro_install')).then($ctx.createCallback(12),$ctx.errback);return;case 12:$ctx.returnValue=true;$ctx.state=14;break;case 14:$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),onAfterDispatch:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var $__10,$__11,e,$__5,$__6,$__7,$__3,$__2,$__9,key,value,$__12,$__13,$__14,$__15,$__16,$__17,$__18,$__19,$__20,$__21,$__22,$__8;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:Promise.resolve($traceurRuntime.superGet(this,InstallController.prototype,"onAfterDispatch").call(this)).then($ctx.createCallback(2),$ctx.errback);return;case 2:Promise.resolve(Class.i('awy_core_model_events')).then($ctx.createCallback(5),$ctx.errback);return;case 5:e=$ctx.value;$ctx.state=4;break;case 4:$__5=true;$__6=false;$__7=undefined;$ctx.state=39;break;case 39:$ctx.pushTry(25,26);$ctx.state=28;break;case 28:$__3=void 0,$__2=(e._events)[Symbol.iterator]();$ctx.state=24;break;case 24:$ctx.state=(!($__5=($__3=$__2.next()).done))?20:22;break;case 19:$__5=true;$ctx.state=24;break;case 20:$__9=$__3.value,key=($__10=$__9[Symbol.iterator](),($__11=$__10.next()).done?void 0:$__11.value),value=($__11=$__10.next()).done?void 0:$__11.value;$ctx.state=21;break;case 21:$__12=e.logger;$ctx.state=10;break;case 10:Promise.resolve($__12).then($ctx.createCallback(8),$ctx.errback);return;case 8:$__13=$ctx.value;$ctx.state=7;break;case 7:$__14=$__13.debug;$__15=$__14.call($__13,"EVENT: "+key);$ctx.state=12;break;case 12:$__16=e.logger;$ctx.state=17;break;case 17:Promise.resolve($__16).then($ctx.createCallback(15),$ctx.errback);return;case 15:$__17=$ctx.value;$ctx.state=14;break;case 14:$__18=$__17.debug;$__19=JSON.stringify;$__20=value.observers;$__21=$__19.call(JSON,$__20);$__22=$__18.call($__17,"OBSERVERS: "+$__21);$ctx.state=19;break;case 22:$ctx.popTry();$ctx.state=26;$ctx.finallyFallThrough=-2;break;case 25:$ctx.popTry();$ctx.maybeUncatchable();$__8=$ctx.storedException;$ctx.state=31;break;case 31:$__6=true;$__7=$__8;$ctx.state=26;$ctx.finallyFallThrough=-2;break;case 26:$ctx.popTry();$ctx.state=37;break;case 37:try{if(!$__5&&$__2.return!=null){$__2.return();}}finally{if($__6){throw $__7;}}
$ctx.state=35;break;case 35:$ctx.state=$ctx.finallyFallThrough;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),action_index:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var l;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:Promise.resolve(Class.i('awy_core_model_layout')).then($ctx.createCallback(3),$ctx.errback);return;case 3:l=$ctx.value;$ctx.state=2;break;case 2:Promise.resolve(l.applyLayout('/')).then($ctx.createCallback(-2),$ctx.errback);return;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),action_s1:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var l;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:Promise.resolve(Class.i('awy_core_model_layout')).then($ctx.createCallback(3),$ctx.errback);return;case 3:l=$ctx.value;$ctx.state=2;break;case 2:Promise.resolve(l.applyLayout('/s1')).then($ctx.createCallback(-2),$ctx.errback);return;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),action_s2:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var l;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:Promise.resolve(Class.i('awy_core_model_layout')).then($ctx.createCallback(3),$ctx.errback);return;case 3:l=$ctx.value;$ctx.state=2;break;case 2:Promise.resolve(l.applyLayout('/s2')).then($ctx.createCallback(-2),$ctx.errback);return;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);}),action_s3:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var l;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:Promise.resolve(Class.i('awy_core_model_layout')).then($ctx.createCallback(3),$ctx.errback);return;case 3:l=$ctx.value;$ctx.state=2;break;case 2:Promise.resolve(l.applyLayout('/s3')).then($ctx.createCallback(-2),$ctx.errback);return;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);})},{},$__super]);},this,arguments);})(Abstract);$__export('default',InstallController);}};});
System.register("/app/distro/install/i18n/en.js",[],function($__export){"use strict";var __moduleName="/app/distro/install/i18n/en.js";var tr;return{setters:[],execute:function(){tr={'test':'best'};$__export('default',tr);}};});
System.register("/app/distro/install/layout.js",[],function($__export){"use strict";var __moduleName="/app/distro/install/layout.js";var l;return{setters:[],execute:function(){l={base:[{view:'head',do:[['css','css/normalize.css@awy_core','css/skeleton.css@awy_core'],['css','css/install.css@distro_install']]}],"/":[{include:'base'},{hook:'main',views:'index'}],"/s1":[{include:'base'},{hook:'main',views:'s1'}],"/s2":[{include:'base'},{hook:'main',views:'s2'}],"/s3":[{include:'base'},{hook:'main',views:'s3'}]};$__export('default',l);}};});
System.register("/app/distro/install/manifest.js",[],function($__export){"use strict";var __moduleName="/app/distro/install/manifest.js";var c;return{setters:[],execute:function(){c={module_name:'distro_install',version:'0.0.0.2',description:"Install sequence extension",require:{module:{awy_core:'0.0.0.1',awy_admin:'0.0.0.1'}},areas:{distro_install:{views:{root:{},index:{view_class:'distro_install_view_index'},s1:{view_class:'distro_install_view_s1'},s2:{view_class:'distro_install_view_s2'},s3:{view_class:'distro_install_view_s3'}}}},routing:[['/','distro_install_controller.index'],['/install','distro_install_controller.index'],['/install/s1','distro_install_controller.s1'],['/install/s2','distro_install_controller.s2'],['/install/s3','distro_install_controller.s3']],themes:{distro_install:{layout_before:'layout.js'}},observe:[]};$__export('default',c);}};});
System.register("/app/distro/install/view/index.js",["awy/core/model/view.js"],function($__export){"use strict";var __moduleName="/app/distro/install/view/index.js";var CoreView,IndexView;return{setters:[function($__m){CoreView=$__m.default;}],execute:function(){IndexView=$traceurRuntime.initTailRecursiveFunction(function($__super){return $traceurRuntime.call(function($__super){function IndexView(params){$traceurRuntime.superConstructor(IndexView).call(this);this._params=params;}
return $traceurRuntime.continuation($traceurRuntime.createClass,$traceurRuntime,[IndexView,{completeStep:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var el,r;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:el=document.querySelector("input[name=agree]");el.parentElement.classList.remove("has-errors");this.set('errors',null);$ctx.state=11;break;case 11:$ctx.state=(!this.get('agree'))?4:3;break;case 4:this.set('errors','<li><i class="fa-li fa fa-close"></i>Please tick the agree to our terms and conditions!</li>');el.parentElement.classList.add("has-errors");$ctx.state=5;break;case 5:$ctx.returnValue=false;$ctx.state=2;break;case 2:$ctx.state=-2;break;case 3:Promise.resolve(Class.i('awy_core_model_router')).then($ctx.createCallback(9),$ctx.errback);return;case 9:r=$ctx.value;$ctx.state=8;break;case 8:r.navigate('install/s1');$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);})},{},$__super]);},this,arguments);})(CoreView);$__export('default',IndexView);}};});
System.register("/app/distro/install/view/s1.js",["awy/core/model/view.js"],function($__export){"use strict";var __moduleName="/app/distro/install/view/s1.js";var CoreView,Step1View;return{setters:[function($__m){CoreView=$__m.default;}],execute:function(){Step1View=$traceurRuntime.initTailRecursiveFunction(function($__super){return $traceurRuntime.call(function($__super){function Step1View(params){$traceurRuntime.superConstructor(Step1View).call(this);this._params=params;}
return $traceurRuntime.continuation($traceurRuntime.createClass,$traceurRuntime,[Step1View,{completeStep:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var keyEl,hostEl,config,db,dbConfig,migri,r,e;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
switch($ctx.state){case 0:keyEl=document.querySelector("input[name=key]");hostEl=document.querySelector("input[name=host]");keyEl.parentElement.classList.remove("has-errors");hostEl.parentElement.classList.remove("has-errors");this.set('errors',null);$ctx.state=51;break;case 51:$ctx.state=(!this.get('db_url')||!this.get('db_key'))?4:3;break;case 4:this.set('errors','<li><i class="fa-li fa fa-close"></i>Please submit all required fields!</li>');if(!this.get('db_url')){hostEl.parentElement.classList.add("has-errors");}
if(!this.get('db_key')){keyEl.parentElement.classList.add("has-errors");}
$ctx.state=5;break;case 5:$ctx.returnValue=false;$ctx.state=2;break;case 2:$ctx.state=-2;break;case 3:Promise.resolve(Class.i('awy_core_model_config')).then($ctx.createCallback(9),$ctx.errback);return;case 9:config=$ctx.value;$ctx.state=8;break;case 8:config.add({db:{host:this.get('db_url'),key:this.get('db_key')}},true);config.writeStorage('db');$ctx.state=53;break;case 53:$ctx.pushTry(23,null);$ctx.state=26;break;case 26:Promise.resolve(Class.i('awy_core_model_db')).then($ctx.createCallback(12),$ctx.errback);return;case 12:db=$ctx.value;$ctx.state=11;break;case 11:Promise.resolve(db.rget('config')).then($ctx.createCallback(15),$ctx.errback);return;case 15:dbConfig=$ctx.value;$ctx.state=14;break;case 14:dbConfig=JSON.parse(dbConfig)||{};if('install_status'in dbConfig&&dbConfig['install_status']=='installed'){throw new Error('Distro is alreay installed in this firebase!!');}
$ctx.state=17;break;case 17:$ctx.popTry();$ctx.state=28;break;case 23:$ctx.popTry();$ctx.maybeUncatchable();e=$ctx.storedException;$ctx.state=21;break;case 21:localStorage.clear();this.set('errors','<li><i class="fa-li fa fa-close"></i>'+e+'</li>');$ctx.state=22;break;case 22:$ctx.returnValue=false;$ctx.state=19;break;case 19:$ctx.state=-2;break;case 28:Promise.resolve(Class.i('awy_core_model_migrate')).then($ctx.createCallback(32),$ctx.errback);return;case 32:migri=$ctx.value;$ctx.state=31;break;case 31:$ctx.pushTry(40,null);$ctx.state=43;break;case 43:Promise.resolve(migri.migrateModules(['awy_core','awy_admin'],true)).then($ctx.createCallback(34),$ctx.errback);return;case 34:$ctx.popTry();$ctx.state=45;break;case 40:$ctx.popTry();$ctx.maybeUncatchable();e=$ctx.storedException;$ctx.state=38;break;case 38:this.set('errors','<li><i class="fa-li fa fa-close"></i>'+e+'</li>');$ctx.state=39;break;case 39:$ctx.returnValue=false;$ctx.state=36;break;case 36:$ctx.state=-2;break;case 45:config.saveDbHostConfig();$ctx.state=55;break;case 55:Promise.resolve(Class.i('awy_core_model_router')).then($ctx.createCallback(49),$ctx.errback);return;case 49:r=$ctx.value;$ctx.state=48;break;case 48:r.navigate('install/s2');$ctx.state=-2;break;default:return $traceurRuntime.continuation($ctx.end,$ctx,[]);}},this,arguments);}),this]);},this,arguments);})},{},$__super]);},this,arguments);})(CoreView);$__export('default',Step1View);}};});
System.register("/app/distro/install/view/s2.js",["awy/core/model/view.js"],function($__export){"use strict";var __moduleName="/app/distro/install/view/s2.js";var CoreView,Step2View;return{setters:[function($__m){CoreView=$__m.default;}],execute:function(){Step2View=$traceurRuntime.initTailRecursiveFunction(function($__super){return $traceurRuntime.call(function($__super){function Step2View(params){$traceurRuntime.superConstructor(Step2View).call(this);this._params=params;}
return $traceurRuntime.continuation($traceurRuntime.createClass,$traceurRuntime,[Step2View,{completeStep:$traceurRuntime.initTailRecursiveFunction(function(){return $traceurRuntime.call(function(){var firstnameEl,lastnameEl,emailEl,passwordEl,password_confirmEl,migri,data,admin,r,e;return $traceurRuntime.continuation($traceurRuntime.asyncWrap,$traceurRuntime,[$traceurRuntime.initTailRecursiveFunction(function($ctx){return $traceurRuntime.call(function($ctx){while(true)
